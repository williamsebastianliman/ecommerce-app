...
export default function SellerLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8FAF9]">
      ...
      <header className="sticky top-0 z-10 bg-[#03AC0E] text-white shadow-md [&_a]:!text-white [&_a:hover]:!text-white">
        <div className="max-w-7xl mx-auto px-5 py-3 flex items-center justify-between gap-3">
          ...
          <nav className="flex items-center gap-2">
            {/* Products */}
            <NavLink to="/seller" end className={linkCls}>
              <svg
              ...
              >
                <path
                  ...
                  d="M20.25 7.5l-8.25 4.5L3.75 7.5m16.5 0v9a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25v-9m16.5 0L12 3.75 3.75 7.5"
                />
              </svg>
            ...
            {/* Profile */}
            <NavLink to="/seller/profile" className={linkCls}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5"
                fill="none"
            ...
            {/* Stock */}
            <NavLink to="/seller/stock" className={linkCls}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5"
                fill="none"
            ...
            {user && (
              <span className="hidden md:block text-sm text-white/90 truncate max-w-[180px] px-2">
                {user.email}
              </span>
            )}
      ...
      {/* Main content (match spacing with user layout) */}
